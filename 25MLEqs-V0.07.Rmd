...
<!---
\begin{center}
\colorbox{white}{\color{navyimpactblue} \huge $\arg\max_{\theta} \prod_{i=1}^n P(x_i | \theta)$}
\end{center}

\begin{center}
\colorbox{white}{\color{navyimpactblue} \huge $\mathop{\mathrm{arg\,max}}_{\theta} \prod_{i=1}^n P(x_i | \theta)$}
\end{center}
--->
