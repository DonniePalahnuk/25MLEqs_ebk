...
This is the total probability of observing the evidence ( $B$ ) under all possible circumstances. It's often calculated as the sum of probabilities for all possible values of $A: \operatorname{P}(B)=\operatorname{P}(B\! \mid\! A) \cdot \operatorname{P}(A)+\operatorname{P}(B\! \mid\! \neg A) \cdot \operatorname{P}(\neg A)$, where $\neg A$ represents the complement of $A$.
...
\draw (Omega_Left) -- (A)       node [midway,above,sloped] 		{$P(A\! \mid\! A)$};
\draw (Omega_Left) -- (notA)    node [midway,below,sloped] 		{$P(\sim\! A\! \mid \sim\! A)$};

% draw lines second layer top from P(A)
\draw (A) -- (AcapB)            node [midway,above,sloped] 		{$P(B\! \mid\! A)$};
\draw (A) -- (AcapnotB)         node [midway,below,sloped] 		{$P(\sim\! B\! \mid\! A)$};

% draw lines second layer bot from P(~A)
\draw (notA) -- (notAcapB) 	    node [midway,above,sloped] 		{$P(B\! \mid \sim\! A)$};
\draw (notA) -- (notAcapnotB) 	node [midway,below,sloped] 		{$P(\sim\! B\! \mid \sim\! A)$};
...
\draw (B) -- (BcapA)            node [midway,above,sloped] 		{$P(A\! \mid\! B)$};
\draw (B) -- (BcapnotA)         node [midway,below,sloped] 		{$P(\sim\! A\! \mid\! B)$};

% draw lines second layer top from P(~B)
\draw (notB) -- (notBcapA)      node [midway,above,sloped] 		{$P(A\! \mid \sim\! B)$};
\draw (notB) -- (notBcapnotA)   node [midway,below,sloped] 		{$P(\sim\! A\! \mid \sim\! B)$};

% draw lines left Omega_Left to P(A) and P(~A)
\draw (Omega_Right) -- (B)      node [midway,above,sloped] 		{$P(B\! \mid\! B)$};
\draw (Omega_Right) -- (notB)   node [midway,below,sloped] 		{$P(\sim\! B\! \mid \sim\! B)$};


}
\end{tikzpicture}
\caption{Prob Graph $\Omega$ bridged by commutative intersection $P(A \cap B) = P(B \cap A)$}.
\label{fig:ProbGraph1-diagram}
\end{figure}


Through graph re-ordering we can better visualize the symmetry around $\Omega$. 
...
{
% define nodes
\node[draw] (Omega_Center) 	at 	(0,0) 		{$\Omega$};
...
\draw (Omega_Center) -- (A) 		node [midway,above,sloped] 		{$P(A\! \mid\! A)$};
\draw (Omega_Center) -- (notA) 	node [midway,above,sloped] 		{$P(\sim\! A\! \mid  \sim\! A)$};
\draw (Omega_Center) -- (B) 		node [midway,above,sloped] 		{$P(B\! \mid\! B)$};
\draw (Omega_Center) -- (notB) 	node [midway,above,sloped] 		{$P(\sim\! B\! \mid \sim\! B)$};

\draw  (A) -- (AcapB) 			node [midway,above,sloped] 			{$P(B\! \mid\! A)$};
\draw  (AcapnotB) -- (A)			node [midway,above,sloped] 			{$P(\sim\! B\! \mid\! A)$};
\draw  (B) -- (AcapB) 			node [midway,above,sloped] 			{$P(A\! \mid\! B)$};
\draw  (B) -- (notAcapB) 			node [midway,above,sloped] 			{$P(\sim\! A\! \mid\! B)$};
\draw  (notB) -- (AcapnotB) 		node [midway,above,sloped] 			{$P(A\! \mid \sim\! B)$};
\draw  (notB) -- (notAcapnotB) 		node [midway,above,sloped] 			{$P(\sim\! A\! \mid \sim\! B)$};
\draw  (notA) -- (notAcapnotB) 		node [midway,above,sloped] 			{$P(\sim\! B\! \mid \sim\! A)$};
\draw  (notAcapB) -- (notA)		node [midway,above,sloped] 			{$P(B\! \mid \sim\! A)$};
